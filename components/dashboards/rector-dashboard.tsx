...
export function RectorDashboard() {
		...
		return (
			<div className='space-y-6'>
				...
				<div className='grid gap-6 md:grid-cols-2'>
					...
					<Card>
						<CardHeader>
							<CardTitle>Dekan Kampusi</CardTitle>
							<CardDescription>Ma'muriy rahbarlik</CardDescription>
						</CardHeader>
						<CardContent>
								...
								<div className='flex items-center space-x-4'>
									...
									<div>
										...
										<p className='text-sm text-muted-foreground'>
											{selectedCampus.dean.experience} tajriba
										</p>
									</div>
								</div>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Eng so'nggi kampus yangilanishlari
							</CardDescription>
						</CardHeader>
						<CardContent>
							<div className='space-y-4'>
				...
				<Card>
					<CardHeader>
						<CardTitle>Kafedralar va Kafedra mudirlari</CardTitle>
						<CardDescription>Akademik kafedralar tafsilotlari</CardDescription>
					</CardHeader>
					<CardContent>
						<div className='space-y-4'>
							{selectedCampus.departments.map((dept, index) => (
								<div key={index} className='border rounded-lg p-4'>
									...
									<div className='grid grid-cols-3 gap-4 text-sm'>
										<div>
											<p className='text-muted-foreground'>Fakultet</p>
											<p className='font-medium'>{dept.faculty}</p>
										</div>
										<div>
											<p className='text-muted-foreground'>Talabalar</p>
											<p className='font-medium'>
												{dept.students.toLocaleString()}
											</p>
										</div>
										<div>
											<p className='text-muted-foreground'>Fan dasturi</p>
				...
				<Card>
					<CardHeader>
						<CardTitle>Kampus inshootlari</CardTitle>
						<CardDescription>Infratuzilma va resurslar</CardDescription>
					</CardHeader>
					<CardContent>
	...
	const renderContent = () => {
		...
		switch (activeTab) {
			case 'campuses':
				return (
					<div className='space-y-6'>
						<h3 className='text-lg font-semibold'>Kampus boshqaruvi</h3>
									...
									<CardHeader>
										<div className='flex justify-between items-start'>
											<div>
												...
												<CardDescription>
													{campus.location} • {campus.colleges} kollejlar •{' '}
													{campus.students.toLocaleString()} talabalar
												</CardDescription>
	...
	return (
		<DashboardLayout
			title='Rektor Boshqaruv Paneli'
			subtitle='Umumiy ko‘rinish va kampuslarni boshqarish'
			tabs={[
				{ id: 'overview', label: 'Umumiy koʻrinish', icon: University },
				{ id: 'campuses', label: 'Kampuslar', icon: Globe },
			]}
			activeTab={activeTab}
