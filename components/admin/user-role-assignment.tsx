...
export function UserRoleAssignment() {
	...
	return (
		<div className='space-y-6'>
			<div className='flex justify-between items-center'>
				<div>
					<h3 className='text-lg font-semibold'>
						Foydalanuvchi rolini belgilash
					</h3>
					<p className='text-muted-foreground'>
						Foydalanuvchilarni va ularning rollarini boshqarish
					</p>
				</div>
							...
							<form onSubmit={handleAddUser} className='space-y-4'>
								<div>
									...
									<Input
										...
										placeholder='masalan, Axmedov Xusniddin'
										required
									/>
								</div>
								<div>
								...
								<div>
									<Label htmlFor='role'>Boshlang'ich roli</Label>
									<Select
									...
									{generatedPassword && (
										<div className='p-3 bg-muted rounded-lg'>
											...
											<p className='text-xs text-muted-foreground mt-2'>
												Foydalanuvchi birinchi kirishda ushbu parolni
												o'zgartirishi kerak.
											</p>
										</div>
									)}
								...
								<div className='flex justify-end space-x-2'>
									...
									<Button type='submit'>Foydalanuvchi Qo'shish</Button>
								</div>
							</form>
						</DialogContent>
					</Dialog>
			...
			<Card>
				<CardHeader>
					<CardTitle>Foydalanuvchilar va Topshiriqlar</CardTitle>
					<CardDescription>
						Foydalanuvchilar ro'yxati va ularning joriy rollari
					</CardDescription>
				</CardHeader>
				<CardContent>
					<Table>
						<TableHeader>
							<TableRow>
								...
								<TableHead>Electron manzil</TableHead>
			...
			<Dialog open={isAssignOpen} onOpenChange={setIsAssignOpen}>
				<DialogContent className='max-w-md'>
					...
					<form onSubmit={handleAssignRole} className='space-y-4'>
						...
						{assignFormData.role !== 'admin' &&
							assignFormData.role !== 'rector' && (
								<>
									<div>
										...
										>
											<SelectTrigger>
												<SelectValue placeholder='Kampus tanlang' />
											</SelectTrigger>
											<SelectContent>
												{campuses.map(campus => (
									...
									{(assignFormData.role === 'department_head' ||
										assignFormData.role === 'teacher') && (
										<>
											<div>
               ...
               Bekor qilish
							...
							<Button type='submit'>Rol tayinlash</Button>
						</div>
					</form>
				</DialogContent>
			</Dialog>
			...
			<Dialog open={isPasswordOpen} onOpenChange={setIsPasswordOpen}>
				<DialogContent className='max-w-md'>
					<DialogHeader>
						<DialogTitle>Parolni tiklash - {selectedUser?.name}</DialogTitle>
					</DialogHeader>
					<div className='space-y-4'>
						<p className='text-sm text-muted-foreground'>
							Yangi parol yaratish orqali foydalanuvchining parolini tiklashingiz
              mumkin. Foydalanuvchi birinchi kirishda ushbu parolni o'zgartirishi
              kerak.
						</p>

						{generatedPassword && (
							<div className='p-4 bg-muted rounded-lg'>
								<p className='text-sm font-medium mb-2'> Yangi parol:</p>
								...
								<p className='text-xs text-muted-foreground mt-2'>
									Foydalanuvchi birinchi kirishda ushbu parolni o'zgartirishi
                  kerak.
								</p>
							</div>
						)}
